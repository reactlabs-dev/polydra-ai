...
const dialogContents: DialogContent[] = [
{
  ...
  paragraphs: [
    "PolydraIQ™ is the proprietary meta-cube analytics engine at the core of AIDAQInsights™. Built to capture every axis of AI maturity, governance, and operational depth, PolydraIQ™ translates complex technical, organizational, and ethical signals into a dynamic, interactive 3D map. Each facet—ranging from Responsible AI to Data Integrity, Compliance, Model Depth, and more—is evaluated through a blend of automated analysis, technical review, and expert validation.",
    "Unlike linear checklists or self-reported dashboards, PolydraIQ™ provides a multidimensional, auditable assessment that adapts to industry context and regulatory change. The result: a transparent, third-party accreditation that brings clarity, trust, and comparability to enterprise AI.",
    "With PolydraIQ™, you see every dimension of your AI readiness—so you can lead with confidence in a rapidly evolving market. The interactive assessment below demonstrates our six-dimensional evaluation framework, allowing you to explore how different factors contribute to overall AI governance maturity."
  ],
},
{
  heading: 'About',
  paragraphs: [
    ...
    "PolydraIQ™, our proprietary meta-cube analytics engine, revolutionizes AI assessment by capturing the complete spectrum of AI maturity across six critical dimensions: Governance & Accountability, Ethics & Responsible AI, Data Integrity & Security, Model Quality & Technical Rigor, Operationalization & Lifecycle Management, and Stakeholder & Societal Impact. Each dimension contains 25 measurable components, ensuring comprehensive evaluation without gaps.",
    ...
    "Our mission: Make enterprise-grade AI governance accessible, measurable, and actionable for organizations of every size. PolydraIQ™ transforms complex AI governance challenges into clear, manageable roadmaps for building trustworthy AI systems."
  ],
